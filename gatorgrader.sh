...
if [ "$CHECK" = true ]; then
  ...
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/www \
                                     --checkfiles index.html --fragments "Montserrat|Roboto+Slab" --fragmentcounts 1
  determine_exit_code $?
  # --> GatorGrader CHECK:
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/www \
                                     --checkfiles index.html --fragments "img/professional_photo.jpg" --fragmentcounts 1
  determine_exit_code $?
  # --> GatorGrader CHECK:
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/www \
                                     --checkfiles index.html --fragments "Professional Biography" --fragmentcounts 1
  determine_exit_code $?
  # --> GatorGrader CHECK:
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/www \
                                     --checkfiles index.html --fragments "<blockquote>" --fragmentcounts 1
  determine_exit_code $?
  # --> GatorGrader CHECK:
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/www \
  ...
  # --> GatorGrader CHECK:
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/www \
                                     --checkfiles index.html --fragments "<footer>" --fragmentcounts 1
  determine_exit_code $?
  # --> GatorGrader CHECK:
  python3 gatorgrader/gatorgrader.py --nowelcome --directories src/www \
